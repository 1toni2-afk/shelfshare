-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('WISHLIST_BOOK_AVAILABLE', 'EXCHANGE_REQUEST_RECEIVED', 'EXCHANGE_REQUEST_ACCEPTED', 'EXCHANGE_REQUEST_REJECTED', 'NEW_MESSAGE');
