...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get adminChatGuidelinesTitle =>
      'Here you can chat with the moderators';

  @override
  String get adminChatGuidelinesIntro =>
      'Write us any question, issue, or report about the app.';

  @override
  String get adminChatGuidelineResponseTime =>
      'It might take a while before someone replies - we\'re not online 24/7.';

  @override
  String get adminChatGuidelineNoSpam =>
      'No spam or repeated messages - one clear message is enough.';

  @override
  String get adminChatGuidelineBeRespectful =>
      'Please keep a respectful tone - we\'re here to help.';
  ...
  @override
  String get bookshelfProgressDialogTitle => 'Reading progress';

  @override
  String get bookshelfProgressField => 'Current page';

  @override
  String bookshelfProgressFieldOfTotal(int total) {
    return 'Current page (of $total)';
  }

  @override
  String get bookshelfProgressError => 'Couldn\'t save the progress.';
  ...
  @override
  String get activityNewListing => 'added a new book';

  @override
  String get activityFinishedBook => 'finished reading';

  @override
  String get activityCompletedExchange => 'completed a swap';

  @override
  String activitySale(String amount) {
    return 'sold for $amount lei';
  }

  @override
  String get activityBadgeNew => 'New';

  @override
  String get activityBadgeFinished => 'Finished';

  @override
  String get activityBadgeExchange => 'Swap';

  @override
  String get activityBadgeSale => 'Sale';

  @override
  String get activityBadgeProgress => 'Reading';

  @override
  String get activityReadingProgress => 'is reading';
  ...
  String activitySwapCaption(
    ...
    return '$name swapped $bookA for $bookB, from $counterparty';
  }
  ...
  String homeBookOfMonth(String title, int count) {
    return 'Book of the Month: $title ($count votes)';
  }

  @override
  String get homeBookOfMonthDiscuss => 'Discuss';

  @override
  String get bookDetailVoteBookOfMonth => 'Vote for Book of the Month';

  @override
  String get bookDetailVotedBookOfMonth => 'You voted for Book of the Month';

  @override
  String get bookDetailVoteError => 'Couldn\'t record the vote.';
  ...
  String get bookDetailBundleAddMore =>
      'Add more books to this offer (optional)';
  ...
  String exchangeOffersBookBundle(String title, int count) {
    return 'Offers: $title + $count more';
  }
  ...
  @override
  String get adminStatsGrowthTitle => 'Users over time';

  @override
  String get adminStatsGrowthDesc => 'Daily snapshot, last 30 days.';

  @override
  String get adminStatsGrowthEmpty => 'Not enough data yet for a chart.';
  ...
  @override
  String get adminConversionFunnelTitle => 'Conversion funnel';

  @override
  String get adminConversionFunnelDesc =>
      'How many users reach each step - from pre-registration to their first completed exchange.';

  @override
  String get adminFunnelPreRegistrations => 'Pre-registrations';

  @override
  String get adminFunnelRegistered => 'Account created';

  @override
  String get adminFunnelOnboarded => 'Completed onboarding';

  @override
  String get adminFunnelListedBook => 'Listed a book';

  @override
  String get adminFunnelExchanged => 'Completed an exchange';
  ...
  @override
  String get adminReportStatusOpen => 'Open';

  @override
  String get adminReportStatusInProgress => 'In progress';
  ...
  @override
  String get adminReportUnassigned => 'Unassigned';

  @override
  String get adminReportMarkInProgress => 'Claim report';

  @override
  String get adminReportMarkResolved => 'Mark resolved';

  @override
  String get adminReportMarkDismissed => 'Dismiss report';

  @override
  String get adminReportReopen => 'Reopen';

  @override
  String get adminReportResolutionNoteLabel => 'Resolution note (optional)';

  @override
  String get adminReportResolutionNoteHint =>
      'What you did or why you dismissed the report';

  @override
  String get adminReportUpdateError => 'Couldn\'t update the report.';

  @override
  String get adminReportedPostLabel => 'Reported post';

  @override
  String get adminReportedReviewLabel => 'Reported review';

  @override
  String get adminDeletePostAction => 'Delete post';

  @override
  String get adminDeleteReviewAction => 'Delete review';

  @override
  String get adminDeletePostConfirmTitle => 'Delete this post?';

  @override
  String get adminDeleteReviewConfirmTitle => 'Delete this review?';

  @override
  String get adminContentDeleted => 'Content deleted.';

  @override
  String get adminContentDeleteError => 'Couldn\'t delete the content.';
  ...
  String get savedSearchesEmpty =>
      'No saved searches yet. Save one to get notified about matching new listings.';

  @override
  String get savedSearchesLoadError => 'Couldn\'t load saved searches.';

  @override
  String get savedSearchNew => 'New search';

  @override
  String get savedSearchLabelLabel => 'Name';

  @override
  String get savedSearchLabelHint => 'e.g. Sci-fi under 30 lei in Cluj';

  @override
  String get savedSearchMaxPriceLabel => 'Max price (optional)';

  @override
  String get savedSearchCreateError => 'Couldn\'t save the search.';

  @override
  String savedSearchMaxPriceChip(String amount) {
    return 'under $amount lei';
  }
  ...
  @override
  String get groupsReportPostTooltip => 'Report post';
  ...
  String bookDetailPriceHistory(String price, int count) {
    return 'Recent average price: $price lei (from $count sales)';
  }

  @override
  String get bookDetailReviewsTitle => 'Reviews';

  @override
  String get bookDetailReviewWrite => 'Write a review';

  @override
  String get bookDetailReviewEdit => 'Edit your review';

  @override
  String get bookDetailReviewDialogTitle => 'Your review';

  @override
  String get bookDetailReviewHint =>
      'What did you think of the book? (optional)';

  @override
  String get bookDetailReviewError => 'Couldn\'t save the review.';
  ...
  @override
  String get bookDetailReviewReportTooltip => 'Report review';

  @override
  String bookDetailReviewsSummary(String average, int count) {
    return '$average out of 5 ($count reviews)';
  }
  ...
  @override
  String get shareSeriesName => 'Series (optional)';

  @override
  String get shareSeriesNumber => 'Volume';
  ...
  @override
  String get settingsAnalyticsSwitch => 'Send anonymous statistics';
  ...
  @override
  String get navAboutApp => 'About the app';
  ...
  String get aboutAppIntro =>
      'A short guide to how each part of ShelfShare works. Open a section for details.';

  @override
  String get aboutAppXpTitle => 'XP and levels';
  ...
  String get aboutAppTrustBody =>
      'The Trust Score is a number between 0 and 100 calculated from your actual activity: verified email, how many exchanges you completed successfully, how fast you reply to messages, how old the account is, reviews received. It\'s not an identity check - it\'s an indicator that helps others know if you\'re a trustworthy swap partner. The more you interact and the better you do it, the higher it goes.';

  @override
  String get aboutAppShelvesTitle => 'My Shelf (Public Bookshelf)';

  @override
  String get aboutAppShelvesBody =>
      'The Shelf is your personal reading status for a book, regardless of whether you own a physical copy or not.\n\n• Reading — the book you\'re working on now\n• Want to read — your wishlist for the future\n• Read — books you\'ve finished\n\nBooks you can swap or sell are separate - they sit in „My Library\" (My Shelf in the menu). A book can be both on the shelf (ex. „Want to read\") and in the library (ex. „I have a copy to sell\") - these are two different concepts.';

  @override
  String get aboutAppHomeSectionsTitle => 'The 3 sections on Home';
  ...
  String get aboutAppExchangesBody =>
      'Two ways to get a book from someone else:\n\n• Exchange — you propose a book from your library in exchange for one from another user\'s library. It\'s free, only shipping cost\n• Price offer — if a book is listed for sale and marked „negotiable\", you can send an offer with a different price. The seller accepts, rejects or counter-offers';

  @override
  String get aboutAppBadgesTitle => 'Badges (Achievements)';

  @override
  String get aboutAppBadgesBody =>
      'Badges are awarded automatically when you reach certain milestones: first swap, 10 swaps, 50 swaps, first review written, first member of the community, supporter badge (if you back the project through „Keep the app alive\"), etc.\n\nThey\'re visible on your public profile. They don\'t have any functional impact - they just recognize the contribution.';
  ...
  String get aboutAppChatBody =>
      'You can start a conversation directly from a book\'s page or another user\'s profile. All messages are encrypted in transit.\n\nSimple safety rule: never share personal data (ID number, card number, full address) in chat. For exchanges, use your postal address only when you\'re sure of the partner.';

  @override
  String get aboutAppAccountDeletionTitle => 'Account deletion';
  ...
  @override
  String get chatEmptySearch => 'No conversation matches your search.';

  @override
  String get chatEmptyUnread => 'All conversations are read.';

  @override
  String get chatSafetyHeadline => 'Welcome to Chat';

  @override
  String get chatSafetyIntro =>
      'This is where you talk to other readers about swaps, offers and books. Pick a conversation from the left, or keep a few rules in mind before you start.';

  @override
  String get chatSafetyPersonalTitle => 'Don\'t share personal data';

  @override
  String get chatSafetyPersonalBody =>
      'ID number, card number, home address or passwords — never in chat. Not even if „it\'s needed for delivery\" or if someone insists.';

  @override
  String get chatSafetyPaymentTitle => 'Safe payments';

  @override
  String get chatSafetyPaymentBody =>
      'For sales, use protected methods (bank transfer with invoice, cash on delivery). Avoid up-front payments to users with no history.';

  @override
  String get chatSafetyMeetupTitle => 'Meet in a public place';

  @override
  String get chatSafetyMeetupBody =>
      'For in-person swaps, pick a café, a library or a central square. Don\'t invite someone to your home on a first swap.';

  @override
  String get chatSafetyReportTitle => 'Report anything suspicious';

  @override
  String get chatSafetyReportBody =>
      'A user asking for personal data, insisting on unusual payments, or whose profile is blank — tap „…\" in the header and report.';

  @override
  String get chatSafetyOpenCenter => 'Open Safety Center';
  ...
  @override
  String get installBannerText => 'Get instant notifications in the app';

  @override
  String get installBannerAction => 'Install';
